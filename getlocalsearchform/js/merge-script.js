/* SCRIPT FOR MAIN JQUERY SCRIPT START */
...
/* ======================= 
SCRIPT FOR DATERANGEPICKER JS START 
 ======================= */
...
(function (root, factory) {if (typeof define === 'function' && define.amd) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.container.find('.ranges')
            ...
            .on('focus.daterangepicker', 'li', $.proxy(this.hoverRange, this))
            //.on('mouseleave.daterangepicker', 'li', $.proxy(this.updateFormInputs, this));

//			this.container.find('.rangebutton')
//            .on('click.daterangepicker', 'button.ranbgebtn', $.proxy(this.clickRange, this))
    ...
    DateRangePicker.prototype = {
        ...
        hide: function(e) {
            ...
            // REMOVED BELOW LINE DUE TO REQUIREMENT FROM "EINAR" - Alpesh
...
//				debugger
        ...
        clickRange: function(e) {
			...
			if (label == this.locale.customRangeLabel) {
				...
				this.updateCalendars();
               // this.showCalendars();
				$('.calendar.right').css("display", "block");
				jQuery('#selected-calender-option').val('r');
            } else {
				this.singleDatePicker=true;
				this.showCalendars();
				this.updateCalendars();
				$('.calendar.right').css("display", "none");
				jQuery('#selected-calender-option').val('s');
            ...
            if (!this.endDate) {
                ...
                this.container.find('.calendar tbody td').each(function(index, el) {
                    ...
                    if ((dt.isAfter(startDate) && dt.isBefore(date)) || dt.isSame(date, 'day')) {
						...
						callback(startDate, date, chosenLabel); //on hover dates selected
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    if (this.startDate.isSame(this.ranges[range][0]) && this.endDate.isSame(this.ranges[range][1])) {
                        customRange = false;
                        this.chosenLabel = this.container.find('.ranges li:eq(' + i + ')').addClass('').html();
                        break;
                    }
                } else {
            ...
            if (customRange) {
                if (this.showCustomRangeLabel) {
                    this.chosenLabel = this.container.find('.ranges li').addClass('').html();
                } else {
        ...
        clickApply: function(e) {
			var trgt=this /* SET TIMEOUT */
			setTimeout(function(){
				trgt.hide();
				trgt.element.trigger('apply.daterangepicker', trgt);
			},500)
